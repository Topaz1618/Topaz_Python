...
tests.py
	...
	pwd = getpass.getpass()
	print(pwd)
G:\Topaz\MyMonitor2\monitor>python tests.py
输入名字>>>topaz
	topaz
Password:
	aa
...
【sys】
	...
	G:\Topaz\MyMonitor2\monitor>python tests.py hello tutu biubiu	
...
【os】
	...
	G:\Topaz\MyMonitor2\monitor>python tests.py
		G:\Topaz\MyMonitor2\monitor 的目录
...
tests.py
	...
	print(a)
	os.system(a[1])
G:\Topaz\MyMonitor2\monitor>python tests.py dir
	['tests.py', 'dir']
	G:\Topaz\MyMonitor2\monitor 的目录
